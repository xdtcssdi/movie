...
<div class="main" id="content">
    <div class="main-inner main-page">
        ...
        <div class="movie-grid">
            ...
            <div class="panel">
                    <span class="panel-more">
                        <a href="movieList" class="textcolor_red" data-act="all-upcomingMovie-click">
                            <span>全部</span>
                        </a>
...
<script>
    ...
    new Vue({
        ...
        mounted() {
            this.initWindow();
            this.initHostMovie(); //初始化正在热映和即将上映电影
        },
        methods: {
            initWindow: function () {
                //图片轮播
                    ...
                    success: function (obj) {
                        ...
                        for (var i = 0; i < ListLength; i++) {
                            htmlHot =
                                ...
                                "<a href=\"movieDetail?movie_id=" + obj.data[i].movie_id + "\" " + "target=\"_blank\" data-act=\"playingMovie-click\" data-val=\"" + obj.data[i].movie_id + "\">" +
                                ...
                                "<a href=\"buyTickets?movie_id=" + obj.data[i].movie_id + '\"' + " class=\"active\" target=\"_blank\" data-act=\"salePlayingMovie-click\" data-val=\"{movieid:42964}\">购 票</a>" +
                                "</div>" +
                                "</div>" +
                                "</li>";
                        ...
                        for (var i = 0; i < ListLength; i++) {
                            ...
                            htmlOn =
                                "<li>" +
                                "<div class=\"movie-item\">" +
                                "<a href=\"movieDetail?movie_id=" + obj.data1[i].movie_id + "\"" + "target=\"_blank\" data-act=\"playingMovie-click\" data-val=\"" + obj.data1[i].movie_id + "\">" +
                                "<div class=\"movie-poster\" style=\"cursor:default;\">" +
