            ...
            <div class="celeInfo-right clearfix">
                ...
                <div class="action-buyBtn">
                    <div class="action clearfix" data-val="{movieid:42964}">
                        ...
                        <a class="score-btn " data-bidd="b_rxxpcgwd" v-on:click="giveScore()">
                            <div>
                        ...
                        <div class="tab-desc tab-content active" data-val="{tabtype:'desc'}">
                            ...
                            <div class="module">
                                ...
                                <div class="mod-content">
                                    ...
                                    <a class="comment-entry" data-act="comment-no-content-click"
                                       onclick="writeComment()">写短评</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            //修改评论
            updateConfirm: function (comment_id, user_name, comment_content, comment_time) {
                layui.use(['laypage', 'layer', 'table'], function () {
                    var laypage = layui.laypage;
                    var layer = layui.layer;
                    var table = layui.table
